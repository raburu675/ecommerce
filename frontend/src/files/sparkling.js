...
function Sparkling() {
    const [products] = useState([
        ...
        //sparkling
        { id: 17, name:"Belaire Brut Fantome", price:5, quantity:"750ml", abv:"ABV: 12%",url:"https://storage.googleapis.com/zoneke/products/-Belaire-Brut-Fantome.webp" ,initialNumber:1},
        { id: 18, name:"Belaire Bleu", price:7, quantity:"750ml", abv:"ABV: 12%",url:"https://storage.googleapis.com/zoneke/products/Belaire-Bleu.webp" ,initialNumber:1},
  ...
  return (
    <div>
           <Modal
            ...
            <h2 className='text-center my-2 sm:my-8 text-rose-800 text-4xl font-vollkorn border-b border-gray-400'>Champagnes Available</h2>
