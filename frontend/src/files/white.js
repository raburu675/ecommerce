...
function White() {
  ...
  return (
    <div>
            ...
            <div className='relative w-full flex flex-col font-vollkorn justify-center items-center pt-24'>
            <h2 className=' text-center my-2 sm:my-8 text-rose-800 text-4xl font-vollkorn border-b border-gray-400'>White Wines Available</h2>
